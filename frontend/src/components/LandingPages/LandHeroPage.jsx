    ...
    >
      ...
      <div className="relative z-20 max-w-5xl text-center">
        <h1 className="text-white text-5xl sm:text-6xl md:text-7xl font-extrabold leading-tight drop-shadow-md">
          ...
          <span className="bg-gradient-to-r from-orange-300 via-blue-500 to-purple-600 text-transparent bg-clip-text">
            PlaceBridge Portal
          </span>
        </h1>
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
          ...
          <button
            type="button"
            className="bg-orange-500 hover:bg-orange-600 transition duration-300 px-6 py-3 rounded-xl text-white font-semibold shadow-lg"
