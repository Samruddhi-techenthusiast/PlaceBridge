  ...
  return (
    ...
    >
      <div className="text-center mb-12">
        <h2 className="text-4xl md:text-5xl font-bold mb-3 playfair">About PlaceBridge</h2>
        <p className="text-md md:text-lg max-w-3xl mx-auto text-gray-700 px-3">
          Developed by Third year students of D.Y.Patil College of Engineering, PlaceBridge (Bridging futures) is a powerful web-based platform to streamline and manage campus placements efficiently.
        </p>
      </div>
      ...
      <div className="flex flex-wrap justify-center items-stretch gap-10">
        {roles.map((role, idx) => (
          ...
          >
            ...
            />
            <h3 className="text-xl md:text-2xl font-semibold mt-4 mb-2 text-orange-700 text-center">{role.title}</h3>
